...
function base16-catppuccin -d "Catppuccin"
  ...
  set color06 89/DC/EB # Base 0C - Cyan
  set color07 D9/E0/EE # Base 05 - White
  ...
  set color15 F5/E0/DC # Base 07 - Bright White
  set color16 E8/A2/AF # Base 09
  set color17 DD/B6/F2 # Base 0F
  set color18 30/2D/41 # Base 01
  set color19 30/2D/41 # Base 02
  set color20 57/52/68 # Base 04
  set color21 C9/CB/FF # Base 06
  ...
  if test -n "$ITERM_SESSION_ID"
    ...
    put_template_custom Pg D9E0EE # foreground
    put_template_custom Ph 1E1E2E # background
    put_template_custom Pi D9E0EE # bold color
    put_template_custom Pj 302D41 # selection color
    put_template_custom Pk D9E0EE # selected text color
    put_template_custom Pl D9E0EE # cursor
  ...
  __base16_fish_shell_create_vimrc_background catppuccin
